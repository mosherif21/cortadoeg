...
import '../../../cashier_side/orders/components/order_widget.dart';
import '../../../cashier_side/orders/components/orders_screen_item_widget.dart';
...
class AdminCustomersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(AdminCustomersScreenController());
    return Scaffold(
  ...
  Widget addCustomerTile({
    required AdminCustomersScreenController controller,
  ...
  Widget _buildChildren({required AdminCustomersScreenController controller}) {
    return Padding(
