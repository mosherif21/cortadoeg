...
class ManageProductDetailsPhone extends StatelessWidget {
  const ManageProductDetailsPhone({
    super.key,
                                  ...
                                  () => _buildTextField(
                                    ...
                                    label: 'costQuantity'.trParams({
                                      'measuringUnit': controller
                                          .selectedMeasuringUnit.value.name.tr
                                    }),
                                    keyboardType: TextInputType.number,
                                ...
                                child: Obx(
                                  () => DropdownButtonHideUnderline(
                                    child: DropdownButton2<MeasuringUnit>(
                                      ...
                                      items: MeasuringUnit.values.map((mUnit) {
                                ...
                                child: Obx(
                                  () => DropdownButtonHideUnderline(
                                    child: DropdownButton2<String>(
                                      ...
                                      items:
                                          productsIconMap.entries.map((entry) {
                                      ...
                                      onChanged: (value) {
                                        if (value != null) {
                                          controller.selectedProductIconName
                                              .value = value;
                                        }
                                      },
                                      dropdownStyleData: DropdownStyleData(
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: IconTextElevatedButton(
                                ...
                                text: 'delete'.tr,
                                onClick: () =>
                                    controller.onDeleteTap(index: productIndex),
                              ),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: SizedBox(
                              ...
                              child: IconTextElevatedButton(
                                ...
                                text: 'save'.tr,
                                onClick: () =>
                                    controller.onSaveTap(index: productIndex),
                              ),
                            ),
                          ),
                        ],
